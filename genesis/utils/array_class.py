...
class ErrorCode(IntEnum):
    ...
    OVERFLOW_MOCHI_CONTACT_PAIRS = 0b00000000000000000000000010000000
    OVERFLOW_MOCHI_CONTACTS = 0b00000000000000000000000100000000
    MOCHI_DIVERGED = 0b00000000000000000000001000000000
    OVERFLOW_MOCHI_CONTACT_CANDIDATES = 0b00000000000000000000010000000000
