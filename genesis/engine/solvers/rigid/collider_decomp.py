...
class Collider:
    ...
    @ti.func
    def _func_clear_single_env(self, i_b: ti.int):
    ...
    @ti.func
    def _func_broad_phase_single_env(self, i_b: ti.int):
        axis = 0
    ...
    @ti.func
    def _func_narrow_phase_terrain_single_env(self, i_b: ti.int):
    ...
    @ti.func
    def _func_narrow_phase_single_env(self, i_b: ti.int):
        for i_pair in range(self.n_broad_pairs[i_b]):
            i_ga = self.broad_collision_pairs[i_pair, i_b][0]
            i_gb = self.broad_collision_pairs[i_pair, i_b][1]
    ...
    @ti.func
    def _func_narrow_phase_nonconvex_nonterrain_single_env(self, i_b: ti.int):
        for i_pair in range(self.n_broad_pairs[i_b]):
            i_ga = self.broad_collision_pairs[i_pair, i_b][0]
            i_gb = self.broad_collision_pairs[i_pair, i_b][1]
